...
public class MediatorTrafficControlSystem extends javax.swing.JFrame {

    public MediatorTrafficControlSystem() {
        initComponents();
    ...
    private void InsertDataToLaneTrafficTable() {
        ...
        String driver = txtDisplayDriverName.getText();
        String numPlate = lblNumberPlate.getText();
        DriverInfo driverInfo = new DriverInfo(tfc, driver, numPlate);

        tfc.addDriver(driverInfo);
        ...
        if (comboLanes.getSelectedIndex() == 1) {
            ...
            String result = driverInfo.request(""
                    + "\n- Status: Open"
                    + "\n- Lane: Lane 1"
                    + "\n- Traffic: Medium");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Mediator Traffic Control System");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MediatorTrafficControlSystem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MediatorTrafficControlSystem().setVisible(true);
            }
        });
    }
