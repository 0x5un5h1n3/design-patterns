...
class Guerilla implements Player {
    ...
    public void mission() {
        //work on the mission
        FlyweightGame game = new FlyweightGame();
        game.setVisible(true);
        System.out.println("Guerilla with weapon " + weapon + " | " + "task is " + TASK);
        FlyweightGame.playerImage.setText("Guerilla with weapon " + weapon + " | " + "task is " + TASK);
    }
}
...
class Soldier implements Player {
    ...
    public void mission() {
        ...
        FlyweightGame.playerImage.setText("Soldier with weapon " + weapon + " | " + "task is " + TASK);
    }
}
...
//Driver Code
    ...
    public JLabel getGamePlayer(String playerType, String CharacterImage, int x, int y){
        FlyweightGame.playerImage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image"+ playerType+"/"+ CharacterImage)));
        FlyweightGame.playerImage.setBounds(x, y, 188, 286);
        return FlyweightGame.playerImage;
    }
